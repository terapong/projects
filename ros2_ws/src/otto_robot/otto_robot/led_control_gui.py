...
class LEDControlGUI(Node):
    def __init__(self, root):
        super().__init__('led_control_gui')
        
        self.subscription = self.create_subscription(Bool, '/led_state', self.listener_callback, 10)             
        self.publisher_ = self.create_publisher(Bool, '/led_command', 10)  #led_state
        ...
        self.label_text_1 = tk.StringVar(value="LED: ")
    ...
    def listener_callback(self, msg):
        self.label_text_1.set(f'LED: "{msg.data}"')
